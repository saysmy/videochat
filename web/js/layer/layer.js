/****************************************
 ...
 @增加tips 属性fix支持 by wheelswnag @ 2014-10-14
 */

;!function(window, undefined){        
"use strict";

var path = 'http://www.feizao001.com/js/layer/', //组件存放目录，为空表示自动获取(不用填写host，相对站点的根目录即可)。
    ...
    switch(config.type){
        ...
        case 4:
            var layArea = [0, layerE.outerHeight()], fow = $(config.tips.follow), fowo = {
                ...
                top: config.fix ? fow.offset().top - $(document).scrollTop() : fow.offset().top,
