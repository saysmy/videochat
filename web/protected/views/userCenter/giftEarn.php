      <div class="pageContent">
        ...
        <div class="userConsume mar">
          <h1>您的消费明细：</h1>
          <div class="userTab" id="userTab"><a href="/userCenter/giftEarn" class="on">收到的礼物</a><a href="/userCenter/giftConsume">送出的礼物</a></div>
          <div class="userItem mt10" id="userItem0">
            ...
            <?php if(!$userInfo['earn']):?>
              <tr>
                <td colspan="5"><div class="userConsumeNull">暂时没有记录！</div></td>
              </tr>
              <?php else:?>
              <?php foreach($userInfo['earn'] as $i):?>
              <tr>
                  <td><b><?=$senders[$i->uid]?></b></td>
                  <td><?=$i['time']?></td>
...
<?php
 $this->widget('CLinkPager',array(
        'pages' => new CPagination($userInfo['earn_total']), 
        'pageSize' => 10,
        'firstPageLabel' => '<<',
        'lastPageLabel' => '>>',
        'nextPageLabel' => '>',
