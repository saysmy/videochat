...
class AppController extends CController {
    ...
    public function filters() {
        return array(
            array(
                'application.filters.LoginFilter + feedback',
            ),
        );  
    }
    ...
    public function actionGetLastestVersion($platform) {
        if ($platform == 'android') {
            return ToolUtils::ajaxOut(0, '', array('version' => '1.0.0', 'url' => 'http://www.efeizao.com/down/feizao.apk', 'new' => array('xxx', 'xxxx', 'xxx')));
        }
